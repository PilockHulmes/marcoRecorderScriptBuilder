...
rightForwardRing = lib.rotateWithInterval(partial(lib.doubleJumpForwardRing, "right"), partial(lib.doubleJumpSlash, "right"), 4)
...
leftForwardRing = lib.rotateWithInterval(partial(lib.doubleJumpForwardRing, "left"), partial(lib.doubleJumpSlash, "left"), 4)
...
leftTripleForwardRing = lib.rotateWithInterval(partial(lib.tripleJumpForwardRing, "left"), partial(lib.tripleJumpSlash, "left"), 4)
